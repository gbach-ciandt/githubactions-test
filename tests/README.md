...
# Dominos-Alsea Mobile Automation Project - Appium + WebDriver.IO - Android
...
#### Appium drivers
If you want Appium to work correctly, you need to download and have the android driver in your system.
Run the commands:
```bash 
...
const androidAppPath = projectPath.join(process.cwd(), "app/android/android-app.apk")
```
